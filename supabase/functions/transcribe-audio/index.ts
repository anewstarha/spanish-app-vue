...
import {
  ...
  CancellationReason,
} from 'npm:microsoft-cognitiveservices-speech-sdk'
      ...
      (res) => {
        ...
        switch (res.reason) {
          ...
          case ResultReason.NoMatch:
            displayResult = { RecognitionStatus: 'NoMatch', DisplayText: '未能识别出任何语音。' };
            break;
          case ResultReason.Canceled:
            ...
            displayResult = { RecognitionStatus: 'Canceled', DisplayText: errorMessage };
            break;
          default:
